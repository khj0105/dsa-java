...
class OrderSystem<T, U> {
	...
	// 1. 클래스 제네릭
	void processOrder(T productName, U quantity) {
		System.out.println("주문 상품: " + productName);
...
//		order.processOrder(100, "마우스");	// err
		
		// 추가 정보 출력 (메서드 제네릭)
		order.printInfo("할인율", 0.15);		// String Double
		order.printInfo("재고여부", true);	// String boolean
